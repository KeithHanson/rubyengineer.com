...
XRegExp.matchRecursive = function (str, left, right, flags, options) {
    ...
    $('.syntaxhighlighter').each( function() {
      ...
      console.log(this, originalHeight, originalWidth);
      
      //$(this).css({'width': '300px', 'height' : '40px'});
      $(this).hover(
        function(){ $(this).animate({width: originalWidth, height: originalHeight}, 300, 'swing'); },
        function(){ $(this).animate({width: 300, height: 40}, 300, 'swing'); }
      )
    });
